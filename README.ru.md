...
- Диагностика runtime, timings последнего запроса и `/cancel`
...
| `LOG_LEVEL` | Нет | Уровень логов Python, обычно `INFO` или `DEBUG`. |
...
| `/sessions` | Постранично показывает сохранённые сессии Gemini, новые сверху |
